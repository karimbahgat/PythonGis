...
class StatusBar(tk.Frame):
    def __init__(self, master, **kwargs):
        ...
        self.task.place(relx=0.0, rely=0.5, anchor="w") #self.task.pack(side="left")
        self.projection = ProjectionStatus(self)
        self.projection.place(relx=0.20, rely=0.5, anchor="w") #.pack(side="left")
        self.zoom = ZoomStatus(self)
        self.zoom.place(relx=0.40, rely=0.5, anchor="w") #.pack(side="right")
        self.mouse = MouseStatus(self)
        self.mouse.place(relx=0.70, rely=0.5, anchor="w") #.pack(side="right")
